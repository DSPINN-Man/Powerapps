            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card className="border border-border/50 bg-gradient-card">
                <CardHeader>
                  ...
                  <CardDescription>
                    Configure the automated workflow parameters
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="sheet-name">Loci Sheet Name</Label>
                      <Select value={sheetName} onValueChange={setSheetName}>
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectItem value="Impedance Loci Vertices">Impedance Loci Vertices</SelectItem>
                          <SelectItem value="Loci Data">Loci Data</SelectItem>
                    ...
                    <div>
                      <Label htmlFor="limits-sheet-name">Limits Sheet Name</Label>
                      <Select value={limitsSheetName} onValueChange={setLimitsSheetName}>
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectItem value="Harmonic Limits">Harmonic Limits</SelectItem>
                  ...
                  <div>
                    <Label htmlFor="loci-unit">Impedance Unit</Label>
                    <Select value={lociUnit} onValueChange={setLociUnit}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="Ω">Ohms (Ω)</SelectItem>
                        <SelectItem value="pu">Per Unit (pu)</SelectItem>
                        <SelectItem value="ohm">ohm</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        <Label htmlFor="reorder-vertices">Reorder Vertices Clockwise</Label>
                        <p className="text-xs text-muted-foreground">Apply clockwise reordering algorithm</p>
                      </div>
                      <Switch
                        id="reorder-vertices"
                        checked={reorderVertices}
                        onCheckedChange={setReorderVertices}
                      />
                    </div>

                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        <Label htmlFor="generate-plots">Generate Analysis Plots</Label>
                        <p className="text-xs text-muted-foreground">Create visualization plots and reports</p>
                      </div>
                      <Switch
                        id="generate-plots"
                        checked={generatePlots}
                        onCheckedChange={setGeneratePlots}
                      />
                    </div>
                  </div>
                </CardContent>
